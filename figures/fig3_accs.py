...
c4 = c[9]
sargs = {'zorder': 10, 's': 4}
ax1.scatter(x, y1, label=r'Isotropic, $\sigma=0$', c=c1[None], **sargs)
ax1.scatter(x, y2, label=r'Isotropic, $\sigma = 1\%$', c=c2[None], **sargs)
ax1.scatter(x, y3, label=r'Isotropic, $\sigma = 10\%$', c=c3[None], **sargs)
ax1.scatter(x, y4, label=r'Anisotropic, $\sigma = 0$', c=c4[None], **sargs)
ax1.plot(x, y0, label='Exact', c='k', lw=2)
